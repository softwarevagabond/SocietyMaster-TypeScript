...
commonModule.factory('viewModelHelper', function ($http, $q) {
    return SocietyMaster.viewModelHelper($http, $q);
});
...
(function (sm) {
    var viewModelHelper = function ($http, $q) {
        ...
        self.apiGet = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            //$http.get(SocietyMaster.rootPath + uri, data)
            $http.get(uri, data)
        ...
        self.apiPost = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            //$http.post(SocietyMaster.rootPath + uri, data)
            $http.post(uri, data)
                .then(function (result) {
                    success(result);
                    if (always != null)
    ...
    sm.viewModelHelper = viewModelHelper;
